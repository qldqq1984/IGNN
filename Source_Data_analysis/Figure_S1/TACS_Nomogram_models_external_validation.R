...
TACS_train_cohort_prediction_results <- data.frame(y = train_cohort$y, DFS = train_cohort$DFS, STATUS = train_cohort$STATUS, model_score = TACS_train_cohort_prediction$model_score, model_risk = TACS_train_cohort_prediction$model_risk)
TACS_test_cohort_prediction_results <- data.frame(y = test_cohort$y, DFS = test_cohort$DFS, STATUS = test_cohort$STATUS,  model_score = TACS_test_cohort_prediction$model_score, model_risk = TACS_test_cohort_prediction$model_risk)
...
Nomogram_train_cohort_prediction_results <- data.frame(y = train_cohort$y, DFS = train_cohort$DFS, STATUS = train_cohort$STATUS, model_score = Nomogram_train_cohort_prediction$model_score, model_risk = Nomogram_train_cohort_prediction$model_risk)
Nomogram_test_cohort_prediction_results <- data.frame(y = test_cohort$y, DFS = test_cohort$DFS, STATUS = test_cohort$STATUS,  model_score = Nomogram_test_cohort_prediction$model_score, model_risk = Nomogram_test_cohort_prediction$model_risk)
