...
for (fold_id in 1:3){
  ...
  TACS_cv_results_file = paste0(dir_root,"/Souce Data/IGNN_IGNNE_performance/pre_validation_TACS_model_prediction.xlsx")
  Nomogram_cv_results_file = paste0(dir_root,"/Souce Data/TACS_Nomogram_performance/pre_validation_Nomogram_model_prediction.xlsx")
