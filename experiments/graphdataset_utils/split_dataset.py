...
def split_dataset(args, dataset):
    ...
    if (args.EXPERIMENT_TYPE == "pre"):
        ...
        #fold1
        if (args.FOLD_N == '1'):
            fold1_train_dataset = dataset[87:261]  + dataset[577:664] + dataset[680:767]     #fold_1
        ...
        #fold12    
            ...
            fold2_train_dataset = dataset[0:87] + dataset[174:261] + dataset[357:513]  + dataset[798:816]     #fold_2
        ...
        #fold1\3
            ...
            fold3_train_dataset = dataset[0:174] + dataset[357:531]     #fold_3
